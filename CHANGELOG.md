...
## [0.4.0] - 2026-04-03 13:00:00

### Added

- Updates the `ogusa_default_parameters.json` with more recent values of macro parameters, demographic data, and tax function parameters.
...
[0.4.0]: https://github.com/PSLmodels/OG-USA/compare/v0.3.1...v0.4.0
