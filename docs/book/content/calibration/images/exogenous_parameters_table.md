...
| $\gamma$                      | Capital share of income                                                 | [0.383...0.383]                                       |
...
| $\alpha^{T}_{t}$              | Transfers as a share of GDP                                             | [0.067...0.067]                                       |
| $\alpha^{G}_{t}$              | Government spending as a share of GDP                                   | [0.049...0.049]                                       |
...
| $\alpha_{D,0}$                | Initial period Debt-to-GDP ratio                                        | 0.982                                                 |
| $\tau_{d,t}$                  | Scale parameter in government interest rate wedge                       | [0.697...0.697]                                       |
| $\mu_{d,t}$                   | Shift parameter in government interest rate wedge                       | [-0.001...-0.001]                                     |
...
| $\texttt{start_year}$         | Initial year                                                            | 2027                                                  |
